...
\begin{frame}{\subsecname}
    \begin{itemize}
        \item LLVM {\color{lightgray}(Low Level Virtual Machine)}
        \item Compiler Infrastruktur\pause
        \item Ursprünglich von Chris Lattner entwickelt\pause
        \item Seit 2014 Teil der LLVM Foundation\pause
        \item LLVM-IR
            \begin{itemize}[<+->]
                \item Abstraktion von der Input-Programmiersprache
                \item Three-address instructions
...
\begin{frame}{\subsecname}
    \begin{itemize}\pause
        \item Instrumentierung mittels Performance Application Programming Interface (PAPI)\pause
        \item Neuer Pass für Polly (FunctionPass)\pause
        \noitem
        \noitem
    \end{itemize}
\end{frame}
...
\begin{frame}{\subsecname}
    \begin{itemize}
        ...
        \item Neues Experiment für benchbuild zur Auslösung des Passes\pause
        \item Auch \enquote{unprofitable} Regions berücksichtigt\pause
    \end{itemize}
\end{frame}
...
\begin{frame}{\subsecname}
    \draftnote{Ich kann doch hier nicht alle 20 (ca.) Gründe erläutern...}
\end{frame}
\begin{frame}{\subsecname}
    \vspace{-0.2cm}
    \begin{figure}[!h]
